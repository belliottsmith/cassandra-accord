...
public class Known
{
    ...
    {
        return privilegedOrdinal() == privilegedVote.ordinal();
    }
    ...
    {
        return privilegedOrdinal() == 0 ? NoVote : VotePreAccept;
    }
    ...
    private int privilegedOrdinal()
    {
        return (encoded & PRIVILEGED_VOTE_MASK) >>> PRIVILEGED_VOTE_SHIFT;
    }
