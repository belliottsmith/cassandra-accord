...
public enum RedundantStatus
{
    ...
    static
    {
        ...
        PARTIALLY_PRE_BOOTSTRAP_OR_STALE.merge.put(LOCALLY_REDUNDANT, LOCALLY_REDUNDANT);
        ...
        PRE_BOOTSTRAP_OR_STALE.merge.put(LOCALLY_REDUNDANT, LOCALLY_REDUNDANT);
        ...
        PARTIALLY_REDUNDANT_PRE_BOOTSTRAP_OR_STALE.merge.put(LIVE, PARTIALLY_REDUNDANT_PRE_BOOTSTRAP_OR_STALE);
        ...
        LOCALLY_REDUNDANT.merge.put(LIVE, PARTIALLY_REDUNDANT_PRE_BOOTSTRAP_OR_STALE);
