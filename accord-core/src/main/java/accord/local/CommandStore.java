...
public abstract class CommandStore implements AgentExecutor
{
    ...
    {
        Invariants.checkState(safeToRead == null || safeToRead.equals(ImmutableSortedMap.of(Timestamp.NONE, Ranges.EMPTY)));
    ...
    {
        Invariants.checkState(bootstrapBeganAt == null || bootstrapBeganAt.equals(ImmutableSortedMap.of(TxnId.NONE, Ranges.EMPTY)));
