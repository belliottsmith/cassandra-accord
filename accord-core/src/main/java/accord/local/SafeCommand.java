...
public abstract class SafeCommand
{
    ...
    public Command.Executed preapplied(SafeCommandStore safeStore, Writes writes, Result result)
    {
        return update(safeStore, Command.preapplied(current(), writes, result));
    }
