...
public abstract class CommandsForKeyGroupUpdater<D>
{
    ...
    public static class Immutable<D> extends CommandsForKeyGroupUpdater<D>
    {
        ...
        public static  <D, T extends Immutable<D>> T merge(T current, T update, Factory<D, T> factory)
        {
            ...
            mergeCommon(update.common().byId(), merged.common.byId(), merged.deps.byId(), merged.all.byId());
            mergeCommon(update.common().byExecuteAt(), merged.common.byExecuteAt(), merged.deps.byExecuteAt(), merged.all.byExecuteAt());

            mergeSpecific(update.deps().byId(), merged.deps.byId(), merged.all.byId(), merged.common.byId());
            mergeSpecific(update.deps().byExecuteAt(), merged.deps.byExecuteAt(), merged.all.byExecuteAt(), merged.common.byExecuteAt());
            mergeSpecific(update.all().byId(), merged.all.byId(), merged.deps.byId(), merged.common.byId());
            mergeSpecific(update.all().byExecuteAt(), merged.all.byExecuteAt(), merged.deps.byExecuteAt(), merged.common.byExecuteAt());
