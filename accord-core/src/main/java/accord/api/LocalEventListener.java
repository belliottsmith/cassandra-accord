...
{
    default void onRejectPreAccept(SafeCommandStore safeStore, Command cmd, Object reason)
    {
    }
    ...
    default void onRejectPreNotAccept(SafeCommandStore safeStore, Command cmd, Object reason)
    {
    }
    ...
    default void onRejectAccept(SafeCommandStore safeStore, Command cmd, Object reason)
    {
    }
    ...
    default void onRejectNotAccept(SafeCommandStore safeStore, Command cmd, Object reason)
    {
    }
    ...
    default void onRejectCommitOrStable(SafeCommandStore safeStore, SaveStatus commitOrStable, Command cmd, Object reason)
    {
    }
