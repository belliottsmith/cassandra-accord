...
abstract class TopologyCollector<C, K, T>
{
    ...
    static class Simple extends TopologyCollector<Topologies.Builder, Routables<?>, Topologies>
    {
    ...
    static class BestFastPath extends TopologyCollector<TxnId.FastPath, Routables<?>, TxnId.FastPath> implements IndexedBiFunction<Shard, Boolean, Boolean>
    {
        final Node.Id self;
    ...
    static class SupportsPrivilegedFastPath extends TopologyCollector<Boolean, Routables<?>, Boolean> implements IndexedBiFunction<Shard, Boolean, Boolean>
    {
        final Node.Id self;
    ...
    static class UnsyncedSelector<K extends Participants<?>> extends TopologyCollector<K, K, K>
    {
    ...
    static class HasChangedReplication extends TopologyCollector<HasChangedReplication.ReplicationChangeTracker, Unseekables<?>, Boolean>
    {
